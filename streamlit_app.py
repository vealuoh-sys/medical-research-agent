...
if run_clicked:
    ...
    if not api_key:
        st.error(
            "GROQ_API_KEY is not set. In your Streamlit Cloud app, go to "
            "Settings -> Secrets and add:\n\nGROQ_API_KEY = \"your-key-here\"\n\n"
            "Never paste your key into this page itself."
        )
        st.stop()
    ...
    stages = [
        ...
        (0.25, "Stage 3: Generating candidate titles", pipeline.run_stage_3, (api_key,)),
        ...
        (0.9, "Stage 8: Drafting the manuscript", pipeline.run_stage_8, (api_key, style)),
    ]
